            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">All Purchase Orders</strong>
                        <button type="button" class="btn btn-success" style="float:right" onclick="location.href='createPurhaseOrder.php';"><i class="fa fa-plus"></i>&nbsp; Create Purchase Order</button>
                    </div>
                    <div class="card-body">
                        <table class="table">
                            <thead>
                            ...
                            <tbody>
                            <?php $sno=1;
                                $get="SELECT DISTINCT purchaseNo, supplier, purchaseDate FROM purchases order by purchaseDate desc";
