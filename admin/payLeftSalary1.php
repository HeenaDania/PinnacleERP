            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group"><label class="form-control-label">Amount to be Paid</label><input type="number" value="<?php echo $data['salaryLeft']; ?>" class="form-control" name="leftSalary" required readonly></div>
                        </div>
                ...
                <div class="card-footer">
                    ...
                    <a href="payLeftSalary.php"><button type="button" class="btn btn-danger">Cancel</button></a> 
                </div>
                </form>
                <?php 
                    if (isset($_POST['pay'])) {
                        $query="update employees set salaryLeft='0' where id = '$_GET[id]'";
                                mysqli_query($con,$query) or die(mysqli_error($con));
                                header("location:payLeftSalary.php?id=$_GET[id]&s=100");    
                    }
                ?>
            </div>
        </div> <!-- .content -->
