            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Company Wise Purchase Orders</strong>
                    ...
                    <div class="card-body">
                        <table class="table">
                            ...
                            <tbody>
                            <?php $sno=1;
                                $get="SELECT DISTINCT purchaseNo, supplier, purchaseDate FROM purchases where supplier = '$companyName' order by purchaseDate desc";
