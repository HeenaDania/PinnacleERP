            ...
            <div class="col-sm-12">
                ...
                <div class="sufee-alert alert with-close alert-success alert-dismissible fade show">
                    <span class="badge badge-pill badge-success">Success</span>
                        Supplier details has been modified successfully.
            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    <div class="card-header">
                        <strong>Modify</strong> Supplier
                    </div>
                    <div class="card-body card-block">
                        <?php 
                            $select = "select * from suppliers where id = '$_GET[id]'";
                    ...
                    if (isset($_POST['save'])) {
                        ...
                        $address=mysql_real_escape_string($_POST['address']);
                            if(preg_match("/^\d+\.?\d*$/",$mobile) && strlen($mobile)==10){
                                $query="update suppliers set companyName='$companyName', ownerName='$ownerName', mobile='$mobile', email='$email', address='$address' where id = '$_GET[id]'";
