            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button" class="btn btn-success" style="float:right" onclick="location.href='createProduct.php';"><i class="fa fa-plus"></i>&nbsp; Add Product</button>
                    </div>
                    <div class="card-body">
                        <table class="table">
                            <thead>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $data['pricePerUnit']; ?></td>
                                    <td>
                                        <a href="editProduct.php?id=<?php echo $data['id'] ?>"><i class="fa fa-edit"></i></a>
                                        <a href="deleteProduct.php?id=<?php echo $data['id'] ?>"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                                <?php $sno++; } ?>
                            </tbody>
