        ...
        <div class="content mt-3">
            ...
            <div class="col-lg-8">
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-success" name="add">Add Supplier</button>
                    <a href="supliers.php"><button type="button" class="btn btn-danger">Cancel</button></a> 
                </div>
                </form>
                <?php 
                    if (isset($_POST['add'])) {
                        ...
                        $address=mysql_real_escape_string($_POST['address']);
                            if(preg_match("/^\d+\.?\d*$/",$mobile) && strlen($mobile)==10){
                                $query="insert into suppliers (companyName,ownerName,mobile,email,address) VALUES ('$companyName','$ownerName','$mobile','$email','$address')";
                                mysqli_query($con,$query) or die(mysqli_error($con));
                                header("location:createSupplier.php?s=101");    
                            }
                            else{
                                header("location:createSupplier.php?s=102");   
                            }
                    }
                ?>
            </div>
